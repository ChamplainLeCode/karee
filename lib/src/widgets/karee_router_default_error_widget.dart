    ...
    return Scaffold(
      ...
      body: Column(
          ...
          children: [
            ...
            Container(
              child: Text('${KareeMaterialApp.globalErrorContactAddress?.appName ?? 'Karee App'}',
                style: TextStyle(
                  fontSize: 15,
            ...
            Container(
              child: Text('[ ${KareeMaterialApp.globalErrorContactAddress?.appVersion ?? 'v2.0.0'} ]',
                style: TextStyle(
                  color: Colors.primaries.first,
                  fontSize: 12,
...
,
            ...
            Container(
              ...
              child: Text('${KareeMaterialApp.globalErrorContactAddress?.appSupportEmail ?? ''}',
                style: TextStyle(
                  color: Colors.primaries.first,
                  fontSize: 12,
                  fontWeight: FontWeight.w300
